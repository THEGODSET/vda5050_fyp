...
{
  new (message_memory) vda5050_msgs::msg::SafetyState(_init);
}

void SafetyState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vda5050_msgs::msg::SafetyState *>(message_memory);
  typed_message->~SafetyState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SafetyState_message_member_array[2] = {
  {
    "e_stop",  // name
    ...
    offsetof(vda5050_msgs::msg::SafetyState, e_stop),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vda5050_msgs::msg::SafetyState, field_violation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SafetyState_message_members = {
  ...
  2,  // number of fields
  sizeof(vda5050_msgs::msg::SafetyState),
...
{
  return &::vda5050_msgs::msg::rosidl_typesupport_introspection_cpp::SafetyState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vda5050_msgs, msg, SafetyState)() {
  return &::vda5050_msgs::msg::rosidl_typesupport_introspection_cpp::SafetyState_message_type_support_handle;
}
