...
#include "vda5050_msgs/msg/detail/visualization__rosidl_typesupport_fastrtps_c.h"
...
using _Visualization__ros_msg_type = vda5050_msgs__msg__Visualization;
...
static uint32_t _Visualization__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vda5050_msgs__msg__Visualization(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs__msg__Visualization;
    is_plain =
      (
...
static size_t _Visualization__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vda5050_msgs__msg__Visualization(
