...
bool vda5050_msgs__msg__optional_parameter__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool vda5050_msgs__msg__protocol_features__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._protocol_features.ProtocolFeatures", full_classname_dest, 52) == 0);
  }
  vda5050_msgs__msg__ProtocolFeatures * ros_message = _ros_message;
  {  // optional_parameters
    PyObject * field = PyObject_GetAttrString(_pymsg, "optional_parameters");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'optional_parameters'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!vda5050_msgs__msg__OptionalParameter__Sequence__init(&(ros_message->optional_parameters), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create vda5050_msgs__msg__OptionalParameter__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    vda5050_msgs__msg__OptionalParameter * dest = ros_message->optional_parameters.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!vda5050_msgs__msg__optional_parameter__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of ProtocolFeatures */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._protocol_features");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ProtocolFeatures");
  ...
  {  // optional_parameters
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->optional_parameters.data[i]);
      PyObject * pyitem = vda5050_msgs__msg__optional_parameter__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "optional_parameters", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
