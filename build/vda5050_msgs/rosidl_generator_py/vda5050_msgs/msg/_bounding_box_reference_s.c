...
bool vda5050_msgs__msg__bounding_box_reference__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._bounding_box_reference.BoundingBoxReference", full_classname_dest, 61) == 0);
  }
  vda5050_msgs__msg__BoundingBoxReference * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of BoundingBoxReference */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._bounding_box_reference");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoundingBoxReference");
