...
bool vda5050_msgs__msg__connection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._connection.Connection", full_classname_dest, 39) == 0);
  }
  vda5050_msgs__msg__Connection * ros_message = _ros_message;
  {  // header_id
  ...
  {  // connection_state
    ...
    rosidl_runtime_c__String__assign(&ros_message->connection_state, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
PyObject * vda5050_msgs__msg__connection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._connection");
  ...
  {  // connection_state
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->connection_state.data,
      strlen(ros_message->connection_state.data),
      "replace");
    if (!field) {
      return NULL;
    }
