...
bool vda5050_msgs__msg__node_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // position
    ...
    if (!vda5050_msgs__msg__node_position__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * vda5050_msgs__msg__node_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // position
    PyObject * field = NULL;
    field = vda5050_msgs__msg__node_position__convert_to_py(&ros_message->position);
    if (!field) {
      return NULL;
    }
    {
