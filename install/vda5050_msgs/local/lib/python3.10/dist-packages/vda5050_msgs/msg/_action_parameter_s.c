...
bool vda5050_msgs__msg__action_parameter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._action_parameter.ActionParameter", full_classname_dest, 50) == 0);
  }
  vda5050_msgs__msg__ActionParameter * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of ActionParameter */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._action_parameter");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActionParameter");
