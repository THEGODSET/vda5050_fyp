...
bool vda5050_msgs__msg__control_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._control_point.ControlPoint", full_classname_dest, 44) == 0);
  }
  vda5050_msgs__msg__ControlPoint * ros_message = _ros_message;
  {  // x
...
PyObject * vda5050_msgs__msg__control_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._control_point");
