...
#include "vda5050_msgs/msg/detail/safety_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // e_stop
#include "rosidl_runtime_c/string_functions.h"  // e_stop

// forward declare type support functions


using _SafetyState__ros_msg_type = vda5050_msgs__msg__SafetyState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: e_stop
  {
    const rosidl_runtime_c__String * str = &ros_message->e_stop;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: e_stop
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->e_stop.data) {
      rosidl_runtime_c__String__init(&ros_message->e_stop);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->e_stop,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'e_stop'\n");
      return false;
    }
  }
...
static uint32_t _SafetyState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vda5050_msgs__msg__SafetyState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs__msg__SafetyState;
    is_plain =
      (
...
static size_t _SafetyState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vda5050_msgs__msg__SafetyState(
