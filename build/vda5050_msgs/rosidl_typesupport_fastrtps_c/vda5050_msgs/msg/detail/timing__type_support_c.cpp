...
#include "vda5050_msgs/msg/detail/timing__rosidl_typesupport_fastrtps_c.h"
...
using _Timing__ros_msg_type = vda5050_msgs__msg__Timing;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: min_order_interval
  {
    cdr << ros_message->min_order_interval;
  }

  // Field name: min_state_interval
  {
    cdr << ros_message->min_state_interval;
  }

  // Field name: default_state_interval
  {
    cdr << ros_message->default_state_interval;
  }

  // Field name: visualization_interval
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Timing__ros_msg_type * ros_message = static_cast<_Timing__ros_msg_type *>(untyped_ros_message);
  // Field name: min_order_interval
  {
    cdr >> ros_message->min_order_interval;
  }
...
static uint32_t _Timing__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vda5050_msgs__msg__Timing(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs__msg__Timing;
    is_plain =
      (
...
static size_t _Timing__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vda5050_msgs__msg__Timing(
