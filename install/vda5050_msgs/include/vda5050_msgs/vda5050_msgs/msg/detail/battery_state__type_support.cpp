...
{
  new (message_memory) vda5050_msgs::msg::BatteryState(_init);
}

void BatteryState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vda5050_msgs::msg::BatteryState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BatteryState_message_member_array[5] = {
  {
    ...
    offsetof(vda5050_msgs::msg::BatteryState, battery_charge),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vda5050_msgs::msg::BatteryState, battery_voltage),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vda5050_msgs::msg::BatteryState, battery_health),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vda5050_msgs::msg::BatteryState, charging),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vda5050_msgs::msg::BatteryState, reach),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BatteryState_message_members = {
  ...
  5,  // number of fields
  sizeof(vda5050_msgs::msg::BatteryState),
...
{
  return &::vda5050_msgs::msg::rosidl_typesupport_introspection_cpp::BatteryState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vda5050_msgs, msg, BatteryState)() {
  return &::vda5050_msgs::msg::rosidl_typesupport_introspection_cpp::BatteryState_message_type_support_handle;
}
