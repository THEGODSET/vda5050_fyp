...
#include "vda5050_msgs/msg/detail/velocity__rosidl_typesupport_fastrtps_c.h"
...
using _Velocity__ros_msg_type = vda5050_msgs__msg__Velocity;
...
static uint32_t _Velocity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vda5050_msgs__msg__Velocity(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs__msg__Velocity;
    is_plain =
      (
...
static size_t _Velocity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vda5050_msgs__msg__Velocity(
