...
#include "vda5050_msgs/msg/detail/connection__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // connection_state, manufacturer, serial_number, timestamp, version
#include "rosidl_runtime_c/string_functions.h"  // connection_state, manufacturer, serial_number, timestamp, version

// forward declare type support functions


using _Connection__ros_msg_type = vda5050_msgs__msg__Connection;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->connection_state;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: connection_state
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->connection_state.data) {
      rosidl_runtime_c__String__init(&ros_message->connection_state);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->connection_state,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'connection_state'\n");
      return false;
    }
  }
...
size_t get_serialized_size_vda5050_msgs__msg__Connection(
  const void * untyped_ros_message,
...
static uint32_t _Connection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vda5050_msgs__msg__Connection(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vda5050_msgs
size_t max_serialized_size_vda5050_msgs__msg__Connection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs__msg__Connection;
    is_plain =
      (
...
static size_t _Connection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vda5050_msgs__msg__Connection(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vda5050_msgs, msg, Connection)() {
