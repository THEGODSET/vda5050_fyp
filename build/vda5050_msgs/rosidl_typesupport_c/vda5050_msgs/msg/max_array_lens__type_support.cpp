...
static const _MaxArrayLens_type_support_symbol_names_t _MaxArrayLens_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vda5050_msgs, msg, MaxArrayLens)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vda5050_msgs, msg, MaxArrayLens)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vda5050_msgs, msg, MaxArrayLens)() {
  return &::vda5050_msgs::msg::rosidl_typesupport_c::MaxArrayLens_message_type_support_handle;
}
