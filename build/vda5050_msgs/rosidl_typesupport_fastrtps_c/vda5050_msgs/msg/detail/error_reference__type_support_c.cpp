...
#include "vda5050_msgs/msg/detail/error_reference__rosidl_typesupport_fastrtps_c.h"
...
using _ErrorReference__ros_msg_type = vda5050_msgs__msg__ErrorReference;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ErrorReference__ros_msg_type * ros_message = static_cast<const _ErrorReference__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _ErrorReference__ros_msg_type * ros_message = static_cast<_ErrorReference__ros_msg_type *>(untyped_ros_message);
  // Field name: reference_key
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _ErrorReference__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vda5050_msgs__msg__ErrorReference(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vda5050_msgs__msg__ErrorReference;
    is_plain =
      (
...
static size_t _ErrorReference__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vda5050_msgs__msg__ErrorReference(
...
static message_type_support_callbacks_t __callbacks_ErrorReference = {
  "vda5050_msgs::msg",
  "ErrorReference",
...
static rosidl_message_type_support_t _ErrorReference__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ErrorReference,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vda5050_msgs, msg, ErrorReference)() {
  return &_ErrorReference__type_support;
}
