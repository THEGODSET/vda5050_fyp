...
bool vda5050_msgs__msg__envelope3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._envelope3_d.Envelope3D", full_classname_dest, 40) == 0);
  }
  vda5050_msgs__msg__Envelope3D * ros_message = _ros_message;
  {  // set
...
{
  /* NOTE(esteve): Call constructor of Envelope3D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._envelope3_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Envelope3D");
