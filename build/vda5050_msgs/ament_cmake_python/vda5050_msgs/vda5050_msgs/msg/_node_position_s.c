...
bool vda5050_msgs__msg__node_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._node_position.NodePosition", full_classname_dest, 44) == 0);
  }
  vda5050_msgs__msg__NodePosition * ros_message = _ros_message;
  {  // x
  ...
  {  // allowed_deviation_x_y
    PyObject * field = PyObject_GetAttrString(_pymsg, "allowed_deviation_x_y");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->allowed_deviation_x_y = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // allowed_deviation_theta
    PyObject * field = PyObject_GetAttrString(_pymsg, "allowed_deviation_theta");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->allowed_deviation_theta = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // map_id
...
{
  /* NOTE(esteve): Call constructor of NodePosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._node_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NodePosition");
  ...
  {  // allowed_deviation_x_y
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->allowed_deviation_x_y);
    {
      int rc = PyObject_SetAttrString(_pymessage, "allowed_deviation_x_y", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // allowed_deviation_theta
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->allowed_deviation_theta);
    {
      int rc = PyObject_SetAttrString(_pymessage, "allowed_deviation_theta", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
