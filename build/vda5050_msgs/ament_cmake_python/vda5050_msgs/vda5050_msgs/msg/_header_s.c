...
bool vda5050_msgs__msg__header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._header.Header", full_classname_dest, 31) == 0);
  }
  vda5050_msgs__msg__Header * ros_message = _ros_message;
  {  // header_id
    ...
    ros_message->header_id = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // timestamp
...
PyObject * vda5050_msgs__msg__header__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._header");
  ...
  {  // header_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->header_id);
    {
