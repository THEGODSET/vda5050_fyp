...
class Metaclass_GetState_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if OrderState.__class__._TYPE_SUPPORT is None:
                OrderState.__class__.__import_type_support__()
...
class GetState_Response(metaclass=Metaclass_GetState_Response):
    ...
    _fields_and_field_types = {
        'state': 'vda5050_msgs/OrderState',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['vda5050_msgs', 'msg'], 'OrderState'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            ...
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        from vda5050_msgs.msg import OrderState
        self.state = kwargs.get('state', OrderState())
    ...
    def state(self, value):
        if __debug__:
            from vda5050_msgs.msg import OrderState
            assert \
                isinstance(value, OrderState), \
                "The 'state' field must be a sub message of type 'OrderState'"
        self._state = value
...
class Metaclass_GetState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vda5050_connector.srv import _get_state
...
class GetState(metaclass=Metaclass_GetState):
    from vda5050_connector.srv._get_state import GetState_Request as Request
    from vda5050_connector.srv._get_state import GetState_Response as Response
