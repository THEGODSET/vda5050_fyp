...
bool vda5050_msgs__msg__instant_actions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vda5050_msgs.msg._instant_actions.InstantActions", full_classname_dest, 48) == 0);
  }
  vda5050_msgs__msg__InstantActions * ros_message = _ros_message;
  {  // header_id
...
{
  /* NOTE(esteve): Call constructor of InstantActions */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vda5050_msgs.msg._instant_actions");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InstantActions");
